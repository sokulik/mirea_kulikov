...
public class Task17 extends JFrame{
    ...
    public Task17(JFrame mainMenuFrame){
        setTitle("Максимум последовательности");
    ...
    private void execution(){
        try {
            ...
            outputArea.append("\nМаксимальное число в последовательности: " + max);
    ...
    private int findMax() {
        ...
        int nextMax = findMax();
        return Math.max(number, nextMax);
    }
    ...
    public static void task17(JFrame mainMenuFrame) {
        SwingUtilities.invokeLater(() -> new Task17(mainMenuFrame).setVisible(true));
    }
}