...
public class ShapeFactory {
    ...
    public static Shape createRandomShape(int maxX, int maxY) {
        ...
        int x = random.nextInt(maxX - 100) + 50;
        int y = random.nextInt(maxY - 100) + 50;
        ...
        switch (shapeType) {
            ...
            case 1: // Прямоугольник
                ...
                return new Rectangle(width, height, randomColor, filled, x, y);
            case 2: // Квадрат
                int side = random.nextInt(80) + 20;
                return new Square(side, randomColor, filled, x, y);
            case 3: // Треугольник
                int base = random.nextInt(80) + 20;
                int triangleHeight = random.nextInt(80) + 20;
                return new Triangle(base, triangleHeight, randomColor, filled, x, y);
            default:
                return null;
        }
    }
